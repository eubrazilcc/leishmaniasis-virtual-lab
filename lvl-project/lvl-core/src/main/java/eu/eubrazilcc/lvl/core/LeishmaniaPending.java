 ...
 */
public class LeishmaniaPending extends PendingSequence implements Linkable<LeishmaniaPending> {

	@InjectLinks({
		@InjectLink(value="pending/leishmania/{urlSafeNamespace}/{urlSafeId}", rel=SELF, type=APPLICATION_JSON, bindings={
	...
	public boolean equals(final Object obj) {
		if (obj == null || !(obj instanceof LeishmaniaPending)) {
			return false;
		}
		final LeishmaniaPending other = LeishmaniaPending.class.cast(obj);
	...
	@Override
	public boolean equalsIgnoringVolatile(final LeishmaniaPending other) {
		if (other == null) {
			return false;
		}
	...
	public static LeishmaniaPendingBuilder builder() {
		return new LeishmaniaPendingBuilder();
	}

	public static class LeishmaniaPendingBuilder extends Builder<LeishmaniaPending> {

		public LeishmaniaPendingBuilder() {
			super(LeishmaniaPending.class);
		}

		public LeishmaniaPendingBuilder links(final List<Link> links) {
			instance.setLinks(links);
			return this;
		}

		public LeishmaniaPending build() {
			return instance;
		}
