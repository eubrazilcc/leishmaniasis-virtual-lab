 ...
 */
public class Wgs84CalculatorTest extends LeishvlTestCase {

	public Wgs84CalculatorTest() {
		super(false);
	}

	@Test
	public void test() {
		printMsg("Wgs84CalculatorTest.test()");
		try {
			...
			printMsg(" >> point A: " + valencia.toString());
			printMsg(" >> point B: " + madrid.toString());
			...
			/* uncomment for additional output */
			printMsg(" >> geographic center: " + center.toString());
			...
			/* uncomment for additional output */
			printMsg(" >> coordinate=" + coordinate + ", normalized=" + normalized);
			...
			/* uncomment for additional output */
			printMsg(" >> coordinates=" + translated.getCoordinates() + ", translated=" + translated.getCoordinates());
			...
			printMsg("Wgs84CalculatorTest.test() has finished");
		}
	}
