...
public class AuthTest {
	...
	public void test() {
		...
		try {
			...
			assertThat("Get user by username coincides with expected", user2.equalsIgnoringVolatile(user));
			/* uncomment for additional output */
			...
			assertThat("Get user by email address coincides with expected", user2.equalsIgnoringVolatile(user));
			/* uncomment for additional output */
			...
			assertThat("Get user by username after update coincides with expected", user2.equalsIgnoringVolatile(user));
			/* uncomment for additional output */
			...
			assertThat("Get user by username after validation coincides with expected", user2.equalsIgnoringVolatile(user));
			/* uncomment for additional output */
