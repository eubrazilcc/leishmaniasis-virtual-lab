...
import eu.eubrazilcc.lvl.storage.oauth2.ResourceOwners;
import eu.eubrazilcc.lvl.storage.oauth2.security.OAuth2SecurityManager;
import eu.eubrazilcc.lvl.storage.security.User;
import eu.eubrazilcc.lvl.storage.security.UserAnonymizer;

/**
 * Implements an identity provider as an OAuth 2.0 Resource Server using Apache Oltu. It receives the validating token in the header of the request.
...
public class IdentityProvider {	
	...
	public ResourceOwners getUsers(final @QueryParam("page") @DefaultValue("0") int page,
		...
		final ResourceOwners paginable = ResourceOwners.start()
				.page(page)
				.perPage(per_page)
				.plain(plain)
				.build();
