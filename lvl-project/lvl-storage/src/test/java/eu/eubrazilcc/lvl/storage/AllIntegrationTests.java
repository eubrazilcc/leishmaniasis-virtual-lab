...
@SuiteClasses({ NotificationCollectionTest.class })
/* TODO @SuiteClasses({ LeishmaniaCollectionTest.class, ReferenceCollectionTest.class, SandflySampleCollectionTest.class, 
