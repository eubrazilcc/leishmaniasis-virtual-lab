...
requirejs.config({
	...
	paths : {
		...
		// TODO 'bootstrap' : '//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min', // 3.3.6
		'bootstrap' : '//cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/js/bootstrap.min', // 3.3.6
