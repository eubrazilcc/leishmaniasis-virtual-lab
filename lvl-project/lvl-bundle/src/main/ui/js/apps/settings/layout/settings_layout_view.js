...
define([ 'app', 'apps/config/marionette/regions/fadein', 'tpl!apps/settings/layout/tpls/settings-layout', 'tpl!apps/settings/layout/tpls/tab-list',
		'tpl!apps/settings/layout/tpls/tab-link' ], function(Lvl, FadeInRegion, LayoutTpl, TabListTpl, TabLinkTpl) {
