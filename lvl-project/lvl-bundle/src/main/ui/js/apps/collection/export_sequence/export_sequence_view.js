/**
 * RequireJS module that defines the view: collection->export_sequence.
 */

define([ 'app', 'tpl!apps/collection/export_sequence/tpls/collection_export_sequence', 'chance', 'backbone.syphon' ], function(Lvl, ExportDatasetTpl, Chance) {
