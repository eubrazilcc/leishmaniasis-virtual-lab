...
define([ 'app', 'apps/config/marionette/regions/fadein', 'tpl!apps/drive/layout/tpls/drive-layout', 'tpl!apps/drive/layout/tpls/tab-list',
		'tpl!apps/drive/layout/tpls/tab-link' ], function(Lvl, FadeInRegion, LayoutTpl, TabListTpl, TabLinkTpl) {
