/**
 * RequireJS module that defines the tour: drive->granted->tour.
 */
					...
					steps : [
							{
								...
								content : 'Use the links here to get around on the objects granted features.'
							},
							{
							...
							},
							{
								...
								content : 'It supports the <a href="/apidoc/" target="_blank">LvLQL</a> query language to search the objects granted. Enter <code>year:1999</code> in the input box and hit <kbd>enter</kbd>. Once the search is completed continue this tour.'
							},
							{
