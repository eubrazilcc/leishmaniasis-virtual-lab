...
define([ 'app', 'marionette', 'tpl!apps/drive/links/tpls/drive_links', 'tpl!apps/drive/links/tpls/toolbar_browse', 'tpl!common/search/tpls/search_term',
		...
		'backgrid-select-all', 'backgrid-filter' ], function(Lvl, Marionette, LinksTpl, ToolbarTpl, SearchTermTpl, AddSearchTermTpl, SaveSearchTpl, pace,
		moment) {
				...
				},
				{
					...
					cell : Backgrid.Cell.extend({
						render : function() {
							...
							var formattedValue = this.formatter.fromRaw(rawValue, this.model);
							if (formattedValue && typeof formattedValue === 'string') {
								this.$el.append('<a href="#" title="Shortened URL" class="text-muted" data-shortened-url="' + formattedValue
										+ '"><i class="fa fa-compress fa-fw"></i></a>');
							}
							this.delegateEvents();
							return this;
						}
