/**
 * RequireJS module that defines the tour: drive->accepted->tour.
 */
					...
					steps : [
							{
								...
								content : 'Use the links here to get around on the objects accepted features.'
							},
							{
							...
							},
							{
								...
								content : 'It supports the <a href="/apidoc/" target="_blank">LvLQL</a> query language to search the objects accepted. Enter <code>year:1999</code> in the input box and hit <kbd>enter</kbd>. Once the search is completed continue this tour.'
							},
							{
