/**
 * RequireJS module that defines the view: social->layout.
 */

define([ 'app', 'apps/config/marionette/regions/fadein', 'tpl!apps/social/layout/tpls/social-layout', 'tpl!apps/social/layout/tpls/tab-list',
		'tpl!apps/social/layout/tpls/tab-link' ], function(Lvl, FadeInRegion, LayoutTpl, TabListTpl, TabLinkTpl) {
	Lvl.module('SocialApp.Layout.View', function(View, Lvl, Backbone, Marionette, $, _) {
	...
	return Lvl.SocialApp.Layout.View;
});