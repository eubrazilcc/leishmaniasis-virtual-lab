/**
 * RequireJS module that defines the tour: social->posts->tour.
 */
					...
					steps : [
							{
								...
								content : 'Use the links here to get around on the posts features.'
							},
							{
							...
							},
							{
								...
								content : 'It supports the <a href="/apidoc/" target="_blank">LvLQL</a> query language to search the posts. Enter <code>text</code> in the input box and hit <kbd>enter</kbd>. Once the search is completed continue this tour.'
							},
							{
