/**
 * RequireJS module that defines the entity: social->tab-link.
 */

define([ 'app', 'backbone.picky' ], function(Lvl) {
	Lvl.module('SocialApp.Entities', function(Entities, Lvl, Backbone, Marionette, $, _) {
		...
		Entities.NavigationSocial = Backbone.Collection.extend({
		...
		var iniNavigationLinks = function() {
			Entities.navigationLinks = new Entities.NavigationSocial([ {
				id : 1,
				link : 'posts',
				icon : 'fa-comments',
				text : 'Posts'
		...
		Lvl.reqres.setHandler('social:navigation:entities', function() {
