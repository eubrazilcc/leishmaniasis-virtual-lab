/**
 * RequireJS module that defines the tour: curation->submitted_sequences->tour.
 */
...
define(
		...
		function(Lvl, hopscotch) {
			return function() {				
				var tour = {
					id : 'curation-submitted_sequences',
					...
					steps : [
							{
								...
								content : 'Use the links here to get around on the curation features.'
							},
							{
							...
							},
							{
								...
								content : 'It supports the <a href="/apidoc/" target="_blank">LvLQL</a> query language to search the curation. Enter <code>partial sequence</code> in the input box and hit <kbd>enter</kbd>. Once the search is completed continue this tour.'
							},
							{
							...
							},
							{
								...
								content : 'Include exporting the selected items and switching to another curation.',
								onNext : function() {
