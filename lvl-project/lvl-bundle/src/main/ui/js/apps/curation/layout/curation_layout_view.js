/**
 * RequireJS module that defines the view: curation->layout.
 */

define([ 'app', 'apps/config/marionette/regions/fadein', 'tpl!apps/curation/layout/tpls/curation-layout', 'tpl!apps/curation/layout/tpls/tab-list',
		'tpl!apps/curation/layout/tpls/tab-link' ], function(Lvl, FadeInRegion, LayoutTpl, TabListTpl, TabLinkTpl) {
	Lvl.module('CurationApp.Layout.View', function(View, Lvl, Backbone, Marionette, $, _) {
	...
	return Lvl.CurationApp.Layout.View;
});