/**
 * RequireJS module that defines the view: statistics->sequences.
 */

define([ 'app', 'tpl!apps/statistics/sequences/tpls/statistics_sequences' ], function(Lvl, StatsSequncesTpl) {
	Lvl.module('StatisticsApp.Sequences.View', function(View, Lvl, Backbone, Marionette, $, _) {
		'use strict';
		View.Content = Marionette.ItemView.extend({
			id : 'sequences',
			template : StatsSequncesTpl,			
			onRender : function() {
			...
			initialize : function() {
				...
				// fetch statistics from LeishVL service
				var self = this;
				self.model.fetch({
					reset : true
				});
	...
	return Lvl.StatisticsApp.Sequences.View;
});