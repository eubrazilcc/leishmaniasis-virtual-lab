/**
 * RequireJS module that defines the view: statistics->layout.
 */

define([ 'app', 'apps/config/marionette/regions/fadein', 'tpl!apps/statistics/layout/tpls/statistics-layout', 'tpl!apps/statistics/layout/tpls/tab-list',
		'tpl!apps/statistics/layout/tpls/tab-link' ], function(Lvl, FadeInRegion, LayoutTpl, TabListTpl, TabLinkTpl) {
	Lvl.module('StatisticsApp.Layout.View', function(View, Lvl, Backbone, Marionette, $, _) {
	...
	return Lvl.StatisticsApp.Layout.View;
});