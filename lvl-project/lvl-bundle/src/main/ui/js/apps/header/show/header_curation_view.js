/**
 * RequireJS module that defines the view: header->curation.
 */

define([ 'app', 'tpl!apps/header/show/tpls/header_curation', 'tpl!apps/header/show/tpls/header_nav', 'tpl!apps/header/show/tpls/header_nav_link',
		'tpl!apps/header/show/tpls/header_notifications', 'moment', 'qtip', 'imagesloaded' ], function(Lvl, CurationHeaderTpl, NavigationTpl, NavigationLinkTpl,
		NotificationsTpl, moment) {
	Lvl.module('HeaderApp.Curation.View', function(View, Lvl, Backbone, Marionette, $, _) {
		'use strict';
	...
	return Lvl.HeaderApp.Curation.View;
});