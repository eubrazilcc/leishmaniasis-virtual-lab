...
define([ 'app', 'tpl!apps/admin/subscription_requests/tpls/admin_subscription_requests', 'tpl!apps/admin/subscription_requests/tpls/toolbar',
		'tpl!common/search/tpls/search_term', 'tpl!common/search/tpls/add_search_term', 'tpl!common/search/tpls/save_search', 'entities/subscription_request',
		'pace', 'moment', 'backbone.oauth2', 'backgrid', 'backgrid-paginator', 'backgrid-select-all', 'backgrid-filter' ], function(Lvl, SubscReqsTpl,
		ToolbarTpl, SearchTermTpl, AddSearchTermTpl, SaveSearchTpl, SubscReqsEntity, pace, moment) {
