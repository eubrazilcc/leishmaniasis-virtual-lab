...
define([ 'marionette', 'apps/config/marionette/configuration', 'apps/config/marionette/regions/dialog' ], function(Marionette, Configuration) {
	'use strict';
