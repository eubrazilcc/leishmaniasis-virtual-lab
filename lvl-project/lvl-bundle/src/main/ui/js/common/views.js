/**
 * RequireJS module that defines the views that are common to all the
 * application and sub-applications.
 */

define([ 'app', 'tpl!common/templates/loading', 'jquery.spin' ], function(Lvl, LoadingTpl, ErrorDialogTpl) {
