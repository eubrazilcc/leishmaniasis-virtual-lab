...
define([ 'app', 'tpl!apps/analysis/submit/tpls/analysis_submit_pipeline', 'tpl!apps/analysis/submit/tpls/parameters',
		'tpl!apps/analysis/submit/tpls/parameter', 'apps/config/marionette/configuration', 'entities/wf_params', 'text!data/pipelines.json', 'backbone.syphon',
		'bootstrap3-typeahead' ], function(Lvl, SubmitPipelineTpl, ParametersTpl, ParamTpl, Configuration, ParamsEntity, PipelinesJson) {
