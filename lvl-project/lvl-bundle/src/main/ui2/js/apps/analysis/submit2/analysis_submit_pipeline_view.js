...
define([ 'app', 'tpl!apps/analysis/submit2/tpls/analysis_submit_pipeline', 'tpl!apps/analysis/submit2/tpls/parameters',
		'tpl!apps/analysis/submit2/tpls/parameter', 'apps/config/marionette/configuration', 'entities/wf_params', 'backbone.syphon', 'bootstrap3-typeahead' ],
			...
			Lvl.module('AnalysisApp.Submit.View', function(View, Lvl, Backbone, Marionette, $, _) {
				...
				View.Content = Marionette.LayoutView.extend({
					...
					submitWorkflow : function(e) {
						...
						// TODO
						console.log('REQUEST_DATA: ' + JSON.stringify(requestData));
						// TODO
