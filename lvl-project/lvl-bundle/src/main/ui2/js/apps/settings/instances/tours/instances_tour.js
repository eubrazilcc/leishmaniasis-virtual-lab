/**
 * RequireJS module that defines the tour: settings->instances->tour.
 */
					...
					steps : [
							{
								...
								content : 'Use the links here to get around on the instances features.'
							},
							{
							...
							},
							{
								...
								content : 'It supports the <a href="/apidoc/" target="_blank">LvLQL</a> query language to search the instances. Enter <code>roles:auth</code> in the input box and hit <kbd>enter</kbd>. Once the search is completed continue this tour.'
							},
							{
