/**
 * RequireJS module that defines the view: admin->layout.
 */

define([ 'app', 'apps/config/marionette/regions/fadein', 'tpl!apps/admin/layout/tpls/admin-layout', 'tpl!apps/admin/layout/tpls/tab-list',
		'tpl!apps/admin/layout/tpls/tab-link' ], function(Lvl, FadeInRegion, LayoutTpl, TabListTpl, TabLinkTpl) {
	Lvl.module('AdminApp.Layout.View', function(View, Lvl, Backbone, Marionette, $, _) {
	...
	return Lvl.AdminApp.Layout.View;
});