/**
 * RequireJS module that defines the tour: saved-items->searches->tour.
 */

define(
		[ 'app', 'apps/config/marionette/styles/style', 'hopscotch' ],
		function(Lvl, Style, hopscotch) {
			return function() {
				require([ 'entities/styles' ], function() {
					var stylesLoader = new Style();
					stylesLoader.loadCss(Lvl.request('styles:hopscotch:entities').toJSON());
				});
				var tour = {
					id : 'saved-items-searches',
					...
					steps : [
							{
								...
								content : 'Use the links here to get around on the saved searches features.'
							},
							{
							...
							},
							{
								...
								content : 'It supports the <a href="/apidoc/" target="_blank">LvLQL</a> query language to search the saved searches. Enter <code>2015</code> in the input box and hit <kbd>enter</kbd>. Once the search is completed continue this tour.'
							},
							{
