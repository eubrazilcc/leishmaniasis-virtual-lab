...
define(
		[ 'app', 'marionette', 'tpl!apps/drive/links/tpls/drive_links', 'tpl!apps/drive/links/tpls/toolbar_browse', 'tpl!common/search/tpls/search_term',
				...
				'backgrid-filter' ], function(Lvl, Marionette, LinksTpl, ToolbarTpl, SearchTermTpl, AddSearchTermTpl, SaveSearchTpl, Style, Configuration,
				pace, moment) {
							...
							cell : Backgrid.Cell.extend({
								render : function() {
									...
									if (formattedValue && typeof formattedValue === 'string') {
										...
										/*
										 * TODO this.$el.append('<a href="' +
										 * config.get('service', '') +
										 * '/public/datasets/' + formattedValue + '"
