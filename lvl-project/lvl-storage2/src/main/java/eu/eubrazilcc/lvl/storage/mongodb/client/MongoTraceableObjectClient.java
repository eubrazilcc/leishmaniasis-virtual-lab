...
/**
 * Data connector based on mongoDB. Previous file versions are kept in the database. The attribute {@link LvlObject#LVL_SPARSE_IS_ACTIVE_FIELD isActive} 
 * of the {@link LvlObject base class} is used to create a sparse index with a unique constraint, enforcing the integrity of the objects within a 
 ...
 * sparse indexes are not supported: {@link LvlObject#LVL_DENSE_IS_ACTIVE_FIELD isActive2}.
