 ...
 */
public class ObjectGrantedResourceTest extends Testable {

	public ObjectGrantedResourceTest(final TestContext testCtxt) {
		super(testCtxt, ObjectGrantedResourceTest.class, true);
	}
