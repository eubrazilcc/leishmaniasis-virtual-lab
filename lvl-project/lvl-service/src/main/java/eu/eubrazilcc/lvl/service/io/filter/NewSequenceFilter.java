 ...
 */
public class NewSequenceFilter extends RecordFilter {

	private static final ImmutableList<String> DATA_SOURCES = of(GENBANK);

	public NewSequenceFilter() {
		super(DATA_SOURCES);
	}
	...
	public static class Builder {
		...
		private final NewSequenceFilter instance = new NewSequenceFilter();

		public NewSequenceFilter build() {
			return instance;
		}
