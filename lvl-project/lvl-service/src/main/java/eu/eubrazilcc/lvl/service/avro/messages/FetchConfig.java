...
public class FetchConfig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FetchConfig(java.util.List<java.lang.CharSequence> ids, eu.eubrazilcc.lvl.service.avro.messages.QueryHistory history, java.lang.Integer start, java.lang.Integer maximum, java.lang.CharSequence outputDir, java.lang.CharSequence format) {
    this.ids = ids;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: history = (eu.eubrazilcc.lvl.service.avro.messages.QueryHistory)value$; break;
   ...
   */
  public eu.eubrazilcc.lvl.service.avro.messages.QueryHistory getHistory() {
    return history;
  }
   ...
   * @param value the value to set.
   */
  public void setHistory(eu.eubrazilcc.lvl.service.avro.messages.QueryHistory value) {
    this.history = value;
  }
  ...
  public static eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder newBuilder() {
    return new eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder();
  }
  
  /** Creates a new FetchConfig RecordBuilder by copying an existing Builder */
  public static eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder newBuilder(eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder other) {
    return new eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder(other);
  }
  
  /** Creates a new FetchConfig RecordBuilder by copying an existing FetchConfig instance */
  public static eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder newBuilder(eu.eubrazilcc.lvl.service.avro.messages.FetchConfig other) {
    return new eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FetchConfig>
    ...
    private Builder() {
      super(eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder other) {
      super(other);
    ...
    private Builder(eu.eubrazilcc.lvl.service.avro.messages.FetchConfig other) {
            super(eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.SCHEMA$);
      if (isValidValue(fields()[0], other.ids)) {
        this.ids = data().deepCopy(fields()[0].schema(), other.ids);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'ids' field */
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder setIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder clearIds() {
      ids = null;
    ...
    /** Sets the value of the 'history' field */
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder setHistory(eu.eubrazilcc.lvl.service.avro.messages.QueryHistory value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder clearHistory() {
      history = null;
    ...
    /** Sets the value of the 'start' field */
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder setStart(int value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder clearStart() {
    ...
    /** Sets the value of the 'maximum' field */
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder setMaximum(int value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder clearMaximum() {
    ...
    /** Sets the value of the 'outputDir' field */
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder setOutputDir(java.lang.CharSequence value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder clearOutputDir() {
      outputDir = null;
    ...
    /** Sets the value of the 'format' field */
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder setFormat(java.lang.CharSequence value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.FetchConfig.Builder clearFormat() {
      format = null;
    ...
    public FetchConfig build() {
      try {
        ...
        record.history = fieldSetFlags()[1] ? this.history : (eu.eubrazilcc.lvl.service.avro.messages.QueryHistory) defaultValue(fields()[1]);
