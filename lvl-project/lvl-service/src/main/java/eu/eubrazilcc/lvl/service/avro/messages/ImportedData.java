...
public class ImportedData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder newBuilder() {
    return new eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder();
  }
  
  /** Creates a new ImportedData RecordBuilder by copying an existing Builder */
  public static eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder newBuilder(eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder other) {
    return new eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder(other);
  }
  
  /** Creates a new ImportedData RecordBuilder by copying an existing ImportedData instance */
  public static eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder newBuilder(eu.eubrazilcc.lvl.service.avro.messages.ImportedData other) {
    return new eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ImportedData>
    ...
    private Builder() {
      super(eu.eubrazilcc.lvl.service.avro.messages.ImportedData.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder other) {
      super(other);
    ...
    private Builder(eu.eubrazilcc.lvl.service.avro.messages.ImportedData other) {
            super(eu.eubrazilcc.lvl.service.avro.messages.ImportedData.SCHEMA$);
      if (isValidValue(fields()[0], other.datasource)) {
        this.datasource = data().deepCopy(fields()[0].schema(), other.datasource);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'datasource' field */
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder setDatasource(java.lang.CharSequence value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder clearDatasource() {
      datasource = null;
    ...
    /** Sets the value of the 'count' field */
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder setCount(int value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder clearCount() {
    ...
    /** Sets the value of the 'hasError' field */
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder setHasError(boolean value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder clearHasError() {
    ...
    /** Sets the value of the 'errorMessage' field */
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder setErrorMessage(java.lang.CharSequence value) {
    ...
    public eu.eubrazilcc.lvl.service.avro.messages.ImportedData.Builder clearErrorMessage() {
      errorMessage = null;
