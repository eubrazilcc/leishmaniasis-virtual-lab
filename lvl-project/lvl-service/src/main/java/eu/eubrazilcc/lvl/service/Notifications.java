...
/**
 * Wraps a collection of notifications.
 * @author Erik Torres <ertorser@upv.es>
 */
public class Notifications extends Paginable<Notification> {
	...
	public static NotificationsBuilder start() {
		return new NotificationsBuilder();
	}

	public static class NotificationsBuilder {

		private final Notifications instance = new Notifications();

		public NotificationsBuilder page(final int page) {
			instance.setPage(page);
			return this;
		}

		public NotificationsBuilder perPage(final int perPage) {
			instance.setPerPage(perPage);
			return this;
		}

		public NotificationsBuilder sort(final String sort) {
			instance.setSort(sort);
			return this;
		}

		public NotificationsBuilder order(final String order) {
			instance.setOrder(order);
			return this;
		}

		public NotificationsBuilder query(final String query) {
		...
		public NotificationsBuilder notifications(final List<Notification> notifications) {
			instance.setElements(notifications);
			return this;
		}
