...
/**
 * Wraps a collection of {@link SubscriptionRequest}.
 * @author Erik Torres <ertorser@upv.es>
 */
public class SubscriptionRequests extends Paginable<SubscriptionRequest> {

	@InjectLinks({
		@InjectLink(resource=SubscriptionRequestResource.class, method="getSubscriptionRequests", bindings={
	...
	public static SubscriptionRequestsBuilder start() {
		return new SubscriptionRequestsBuilder();
	}

	public static class SubscriptionRequestsBuilder {

		private final SubscriptionRequests request = new SubscriptionRequests();

		public SubscriptionRequestsBuilder page(final int page) {
			request.setPage(page);
			return this;
		}

		public SubscriptionRequestsBuilder perPage(final int perPage) {
			request.setPerPage(perPage);
			return this;
		}

		public SubscriptionRequestsBuilder sort(final String sort) {
			request.setSort(sort);
			return this;
		}

		public SubscriptionRequestsBuilder order(final String order) {
			request.setOrder(order);
			return this;
		}

		public SubscriptionRequestsBuilder query(final String query) {
			request.setQuery(query);
			return this;
		}

		public SubscriptionRequestsBuilder totalCount(final int totalCount) {
			request.setTotalCount(totalCount);
			return this;
		}

		public SubscriptionRequestsBuilder requests(final List<SubscriptionRequest> requests) {
			request.setElements(requests);
			return this;			
		}
