...
public class DatasetOpenAccesses extends Paginable<DatasetOpenAccess> {
	...
	public static DatasetOpenAccessesBuilder start() {
		return new DatasetOpenAccessesBuilder();
	}
	...
	public static class DatasetOpenAccessesBuilder {
		...
		public DatasetOpenAccessesBuilder perPage(final int perPage) {
			instance.setPerPage(perPage);
			return this;
		}

		public DatasetOpenAccessesBuilder shares(final List<DatasetOpenAccess> openAccesses) {
			instance.setElements(openAccesses);
			return this;			
		}

		public DatasetOpenAccesses build() {
			return instance;
		}
