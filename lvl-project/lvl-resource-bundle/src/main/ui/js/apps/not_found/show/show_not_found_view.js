...
define([ 'app', 'tpl!apps/not_found/show/templates/not_found', 'tpl!apps/not_found/show/templates/navigation', 'tpl!apps/not_found/show/templates/external',
        'flatui-checkbox', 'flatui-radio' ], function(Lvl, NotFoundTpl, NavigationTpl, ExternalTpl) {
    Lvl.module('NotFoundApp.Show.View', function(View, Lvl, Backbone, Marionette, $, _) {
        ...
        View.Content = Marionette.Layout.extend({
