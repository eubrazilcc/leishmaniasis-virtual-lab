...
define([ 'app', 'tpl!apps/collection/sequence_viewer/templates/collection_sequence_viewer' ], function(Lvl, DisplaySequenceTpl) {
	Lvl.module('CollectionApp.Sequence.View', function(View, Lvl, Backbone, Marionette, $, _) {
		...
		View.Content = Marionette.ItemView.extend({
			...
			templateHelpers : {
				...
				gbGI : function() {
					var gi = '';
					if (this['GBSeq_other-seqids'] && this['GBSeq_other-seqids'].GBSeqid) {
						var seqIds = this['GBSeq_other-seqids'].GBSeqid;
