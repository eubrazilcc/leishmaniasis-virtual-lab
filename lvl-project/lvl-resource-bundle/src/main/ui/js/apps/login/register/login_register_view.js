...
define([ 'app', 'tpl!apps/login/register/templates/register', 'apps/config/marionette/styles/style', 'bootstrapvalidator', 'flatui-checkbox', 'flatui-radio' ],
        function(Lvl, RegisterTpl, Style) {
