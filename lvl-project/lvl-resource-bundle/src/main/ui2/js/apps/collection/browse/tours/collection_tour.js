/**
 * RequireJS module that defines the tour: collection->tour.
 */
					...
					steps : [
							{
								...
								content : 'Use the links here to get around on the collection features.'
							},
							{
							...
							},
							{
								...
								content : 'Include exporting the selected items and switching to another collection.',
								onNext : function() {
