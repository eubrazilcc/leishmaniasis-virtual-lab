...
requirejs.config({
	...
	paths : {
		...
		'bootstrapvalidator' : [ '//cdnjs.cloudflare.com/ajax/libs/jquery.bootstrapvalidator/0.5.3/js/bootstrapValidator.min',
				'vendor/cached/bootstrapValidator.min' ],
		/* Backbone + Marionette MVC framework */
		'underscore' : [ '//cdnjs.cloudflare.com/ajax/libs/underscore.js/1.7.0/underscore-min', 'vendor/cached/underscore-min' ],
		...
		'qtip' : [ '//cdnjs.cloudflare.com/ajax/libs/qtip2/2.2.1/jquery.qtip.min', 'vendor/cached/jquery.qtip.min' ],
